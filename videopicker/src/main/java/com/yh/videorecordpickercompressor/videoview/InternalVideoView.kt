...
class InternalVideoView @JvmOverloads constructor(mContext: Context, attrs: AttributeSet, defStyleAttr: Int = 0) : FullScreenVideoView(mContext, attrs, defStyleAttr)/*, View.OnTouchListener*/ {
